...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const signInRes = await signIn('guest-login', {
        email,
        password,
        redirect: false,
      });
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Join Royal Amethyst for exclusive reservations</p>
        </div>

        <Card className="border-none shadow-2xl glass-panel relative z-10">
          <CardContent className="pt-8 space-y-6">
            <Button variant="outline" className="w-full h-12 relative flex items-center justify-center gap-3" onClick={handleGoogleRegister}>
